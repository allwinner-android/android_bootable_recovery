...
const int IR_KEYCODE_HOME = 71;
const int IR_KEYCODE_UP =  67;
const int IR_KEYCODE_DOWN = 10;
const int IR_KEYCODE_ENTER =  2;
...
int ir_handle_input(input_event ev,RecoveryUI *ui){
	...
	IR_KEY_CODE ir_keycode = ir_convert_keycode(ir_key_code);
	int handled = 0;
